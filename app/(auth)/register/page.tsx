            ...
            <div className="w-full max-w-[400px]">
                ...
                <div className="rounded-[14px] border border-[#2a3d33] bg-[#1a2520] p-8">
                    ...
                    <div className="mb-7">
                        ...
                        <p className="mt-1.5 text-[12px] leading-[1.6] text-[#7a9e8a]">
                            Tidak perlu kartu kredit. Akses langsung setelah daftar.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Terms */}
                        <p className="text-[11px] leading-[1.65] text-[#4a6458]">
                            Dengan mendaftar, kamu menyetujui{" "}
                            <Link href="/terms" className="text-[#7a9e8a] underline underline-offset-2 transition hover:text-[#9ab0a2]">
                                Syarat & Ketentuan
                            </Link>{" "}
                            dan{" "}
                            <Link href="/privacy" className="text-[#7a9e8a] underline underline-offset-2 transition hover:text-[#9ab0a2]">
                                Kebijakan Privasi
                            </Link>{" "}
                            Grove.
                        </p>
